...
suite('Unit Tests', () => {
    ...
    test('check valid puzzle entries', function () {
        ...
        assert.equal(solver.validate({
            ...
            coordinate: 'a6',
            value: '2'
            }), "{ error: 'Invalid coordinate' }", 'puzzle input too long');
        assert.equal(solver.validate({
            puzzle: '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..',
            coordinate: 'c4',
            value: '3'
            }), "{ error: 'Invalid coordinate' }", 'bad number 0 in puzzle input');
        assert.equal(solver.validate({
            puzzle: '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..',
            coordinate: 'b3',
            value: '4'
            }), "{ error: 'Invalid coordinate' }", 'bad alpha character [j-z] in coordinate input');
    });
});
