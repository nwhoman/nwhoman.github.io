class SudokuSolver {
  ...
  checkCurrentCell(puzzleString, row, column, value) {
    ...
    console.log(row, rowValue, index, puzzleString[index])
    if (puzzleString[index] === value) {
      return errors;
    } else {
      console.log('here')
      return this.checkRowPlacement(puzzleString, rowValue, column, value)
    }
  }
  ...
  checkRowPlacement(puzzleString, row, column, value) {
    ...
    console.log('here')
    return this.checkColPlacement(puzzleString, row, column, value, errorMessages)
  }
