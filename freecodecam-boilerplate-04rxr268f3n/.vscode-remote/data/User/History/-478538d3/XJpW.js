...
app.post('/api/users/:_id/exercises', async (req, res) => {
  ...
  .then(user => {
    console.log(user);
    const exercise = await constructs.createExercise(user.username, req.body.description, req.body.duration, req.body.date, req.params._id)
  
})
  
  const exercise = await return res.json(exercise)
});
