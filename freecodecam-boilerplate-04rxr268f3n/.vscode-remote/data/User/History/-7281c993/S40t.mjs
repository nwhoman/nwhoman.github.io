...
const createUser = async (username, count, log) => {
...
export {createExercise, createUser, findExercises, findExerciseById, updateExercise, deleteExercise, deleteExercises};