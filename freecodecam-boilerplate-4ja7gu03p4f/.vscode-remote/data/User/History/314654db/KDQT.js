...
module.exports = function (app) {
  ...
  app.route('/api/issues/:project')
    ...
    .post(async function (req, res){
      ...
      console.log('date ', issueModel.formatDate());
...
console.log('issue ', issue)
        ...
        return res.json({
          ...
          issue_text: issue.issue_text ? issue.issue_title : '',
          created_on: issue.created_on ? issue.issue_title : '',
          updated_on: issue.updated_on ? issue.issue_title : '',
          created_by: issue.created_by ? issue.issue_title : '',
          assigned_to: issue.assigned_to ? issue.issue_title : '',
          open: issue.open,
